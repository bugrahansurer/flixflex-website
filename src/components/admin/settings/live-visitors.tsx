...
export function LiveVisitors() {
  ...
  return (
    <div className="ff-shape-container ff-card bg-[#F7F7F5] border-[#CCCCCC] text-[#0D0D0D] p-5 mb-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-display text-sm font-bold text-[#0D0D0D]">Canlı Ziyaret (First-party)</h3>
        </div>
        <span className="text-[10px] text-right text-[#0D0D0D]/40">Her 15sn güncellenir</span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-[11px] text-[#0D0D0D]/60 mt-1">Şu an aktif</p>
        </div>
        <div>
          <p className="font-display text-3xl font-bold tabular-nums flex items-center gap-1.5">
            <Eye size={16} className="text-[#0D0D0D]/40" />{live ? live.todayViews.toLocaleString("tr-TR") : "—"}
          </p>
          <p className="text-[11px] text-[#0D0D0D]/60 mt-1">Bugün görüntülenme</p>
        </div>
        <div>
          <p className="font-display text-3xl font-bold tabular-nums flex items-center gap-1.5">
            <Users size={16} className="text-[#0D0D0D]/40" />{live ? live.todayVisitors.toLocaleString("tr-TR") : "—"}
          </p>
          <p className="text-[11px] text-[#0D0D0D]/60 mt-1">Bugün tekil ziyaretçi</p>
        </div>
      </div>
